            ...
            <header className="bg-gray-100 shadow-sm">
                <div className="max-w-6xl mx-auto px-6 py-6 flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex gap-8 text-base text-gray-600">
                        ...
                        <a href="https://apps.apple.com/gb/app/checkmyplate/id6683283815" target="_blank" rel="noopener noreferrer" className="hover:text-black"></a>
                    </nav>
                ...
                {isOpen && (
                    <div className="md:hidden px-6 pb-4 space-y-4 text-base text-gray-600">
                        ...
                        <a href="https://apps.apple.com/gb/app/checkmyplate/id6683283815" target="_blank" rel="noopener noreferrer" className="block hover:text-black"> App Store</a>
                    </div>
                )}
            </header>
                ...
                <div className="max-w-6xl mx-auto px-0 py-15 grid md:grid-cols-2 gap-20 items-center">
                    <div className="md:ml-0">
                        ...
                        <form
                            ...
                            <button
                                type="submit"
                                className="bg-black text-white px-10 py-5 rounded-md hover:bg-gray-800 transition text-xl font-semibold">Check Now</button>
                        </form>
                    </div>
